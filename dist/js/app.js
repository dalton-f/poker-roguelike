...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_deckManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/deckManager */ "./src/js/components/deckManager.js");
...
document.addEventListener("DOMContentLoaded", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
  ...
  return _regenerator().w(function (_context2) {
    while (1) switch (_context2.n) {
      case 0:
        deckManager = new _components_deckManager__WEBPACK_IMPORTED_MODULE_0__.DeckManager();
        _context2.n = 1;
        return deckManager.generateDeck();
      case 1:
        deckData = _context2.v;
        _context2.n = 2;
        return deckManager.drawCards(8);
      case 2:
        ...
        _loop = /*#__PURE__*/_regenerator().m(function _loop() {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                checkbox = _checkboxes2[_i2];
                checkbox.addEventListener("change", function () {
                  selectedCheckboxes = checkboxes.filter(function (cb) {
                    return cb.checked;
                  });

                  // Grab the ids from the checkbox input to store the cards directly
                  gameState.selectedCards = selectedCheckboxes.map(function (cb) {
                    return drawnCards[cb.id];
                  });
        ...
        _i2 = 0, _checkboxes2 = checkboxes;
      case 3:
        if (!(_i2 < _checkboxes2.length)) {
          _context2.n = 5;
          break;
        }
...
var displayCards = function displayCards(drawnCards) {
  ...
  for (var i = 0; i < drawnCards.length; i++) {
    ...
    image.classList.add("max-w-30", "object-cover", "transition-transform", "duration-150", "ease-linear", "group-has-[input:checked]:translate-y-[-2rem]");
...
/***/ "./src/js/components/deckManager.js":
/*!******************************************!*\
  !*** ./src/js/components/deckManager.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var DeckManager = /*#__PURE__*/function () {
  function DeckManager() {
    _classCallCheck(this, DeckManager);
    this.deckId = null;
  }
  return _createClass(DeckManager, [{
    key: "generateDeck",
    value: function () {
      var _generateDeck = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 5:
              _context.p = 5;
              _t = _context.v;
              throw new Error("Failed to geneate the deck: ", _t);
            case 6:
              return _context.a(2);
          }
        }, _callee, this, [[1, 5]]);
      ...
      function generateDeck() {
        return _generateDeck.apply(this, arguments);
      }
      return generateDeck;
    }()
  }, {
    key: "drawCards",
    value: function () {
      var _drawCards = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(count) {
        var url, response, data, _t2;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              url = "https://deckofcardsapi.com/api/deck/".concat(this.deckId, "/draw/?count=").concat(count);
              if (this.deckId) {
                _context2.n = 1;
                break;
              }
              throw new Error("Generate a deck before drawing cards");
            case 1:
              _context2.p = 1;
              _context2.n = 2;
              return fetch(url);
            case 2:
              ...
              throw new Error("Failed to draw cards: ", response);
            case 3:
              _context2.n = 4;
              return response.json();
            case 4:
            ...
            case 5:
              _context2.p = 5;
              _t2 = _context2.v;
              throw new Error("Failed to draw cards: ", _t2);
            case 6:
              return _context2.a(2);
          }
        }, _callee2, this, [[1, 5]]);
      }));
      function drawCards(_x) {
        return _drawCards.apply(this, arguments);
      }
      return drawCards;
    }()
  }]);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpoker_roguelike"] = self["webpackChunkpoker_roguelike"] || [];
